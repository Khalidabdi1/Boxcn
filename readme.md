تمام ✅ إليك **نسخة كاملة بصيغة Markdown (README.md)**
تشمل: وصف المشروع، الصورة، طريقة التثبيت والاستخدام، المزايا، المساهمة، الترخيص، مع تحسين كامل لمحركات البحث (SEO) لتناسب GitHub وnpm.
